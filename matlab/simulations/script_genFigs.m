...
% New version of Fig 3 (Feb 2026). 
% Using simDat from script_simulations

% panels as follows, in a 3x3 grid: 
% a, perf by firing rate
% b, perf by rec dur
% c, perf by refractory period
% d, Llobet by firing rate
% e, Llobet by rec dur
% f, Llobet by refractory period
% g, overlay Sliding/Llobet by firing rate
% h, overlay by rec dur
% i, overlay by RP dur
...
f.Position = [1000         104        1242        1134];

print(f, 'Fig3', '-dpdf', '-bestfit', '-vector');
